...
const { CreateOrUpdate, getStudentProfile, getStudentsByDepartment, getMyRequests, getPendingRequests, getRequestById, approveRequest, rejectRequest, getAllStudents, deleteStudent, updateStudentAdmin, deleteProfileRecord } = require('../controllers/studentProfile.controller');
...
// Restored (Phase 1 gap close) - matches frontend's
// DELETE ${SERVER}/api/student/record/${section}/${recordId} exactly.
router.delete('/record/:section/:recordId', authMiddleware, deleteProfileRecord);
