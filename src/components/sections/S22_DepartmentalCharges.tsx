...
import { departmentalChargesOptions, institutionsOptions } from '../../shared/dropdownOptions';
...
export default function DepartmentalCharges({ data, onChange, onPersist }: { data: any; onChange: (d: any) => void; onPersist?: (d: any, showToast?: boolean) => Promise<void> | void }) {
