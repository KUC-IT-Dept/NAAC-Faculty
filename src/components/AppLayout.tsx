...
const profileDropdownItems = (role?: 'admin' | 'faculty') => {
  ...
  return [
    ...
    { id: 'internship-projects', label: '10 - Internship and Projects', path: `${base}/internship-projects` },
    { id: 'memberships', label: '11 - Memberships', path: `${base}/memberships` },
    { id: 'fdp-workshops', label: '12 - Attended FDP & Workshops', path: `${base}/fdp-workshops` },
    { id: 'online-courses', label: '13 - Online Courses', path: `${base}/online-courses` },
    { id: 'international-experience', label: '14 - Academic International Experience', path: `${base}/international-experience` },
